...
<h2 style = "color: black; margin-left: 30px; font-weight: 700"> List of Books </h2> 
...
<?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(mysqli_num_rows($sql) == 0)
            {
                ...
                echo "<tr style = 'background-color:#dadf748f;'>";
        ...
        /* if ang button kay dili i press or mag search*/
        else{
